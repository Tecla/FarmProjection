...
def GenerateReport(scenario):
    ...
    for a in animals:
        ...
        root['Creamery'][a]['Buttermilk gallons sold per year'] = rounded(buttermilkGallonsByAnimalPerYear(s, a), 0)
        root['Creamery'][a]['Buttermilk gallons sold per week'] = rounded(buttermilkGallonsByAnimalPerWeek(s, a), 2)
        root['Creamery'][a]['Buttermilk sales per year'] = dollars(buttermilkSalesByAnimalPerYear(s, a))
